										...
										<div class="row">
											<!--<div class="col-xxs-12 col-xs-12 mt">
												<div class="input-field">
													<input type="text" class="form-control" id="from-place" placeholder="E-Mail ID"/>
												</div>
												<br/>
												<div class="input-field">
													<input type="password" class="pathik" id="from-place" placeholder="Password" />
												</div>
											</div>-->
	<!--
